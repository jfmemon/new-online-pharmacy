...
const MedicalDevicesItems = () => {
    const [medicalDevices, refetch] = useMedicalDevices();
        ...
        fetch(imageHostingURL, {
            ...
            .then(imageRes => {
                if (imageRes.success) {
                    ...
                    console.log(data);
                    axiosSecure.post('/medicalDevices', data)
                        .then(data => {
    ...
    return (
        <div className='px-10'>
            <div>
                <h3 className='py-4 pl-2 text-2xl font-semibold'>Total items: <span className='text-rose-500'>{medicalDevices.length}</span></h3>
            </div>
...
export default MedicalDevicesItems;