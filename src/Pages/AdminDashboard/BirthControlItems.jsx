...
const BirthControlItems = () => {
    const [birthControl, refetch] = useBirthControl();
        ...
        fetch(imageHostingURL, {
            ...
            .then(imageRes => {
                if (imageRes.success) {
                    ...
                    console.log(data);
                    axiosSecure.post('/birthControl', data)
                        .then(data => {
    ...
    const handleDeleteItem = item => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch(`https://online-pharmacy-server.vercel.app/birthControl/${item._id}`, {
                    method: 'DELETE'
                })
                    .then(res => res.json())
                    .then(data => {
...
export default BirthControlItems;