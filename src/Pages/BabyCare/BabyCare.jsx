    ...
    return (
        <div className='p-5'>
            <div className='pt-2 pb-3'>
                <h3 className='text-xl font-semibold md:pl-2 pl-3 my-2 text-indigo-500'>Baby Care</h3>
                <small className='md:pl-2 pl-3 text-gray-500'>{babyCare?.length} items found in Baby Care</small>
            </div>
            <div className='grid lg:grid-cols-5 md:grid-cols-3 grid-cols-1 gap-5 justify-center md:my-10'>
                {
                    babyCare.map(items =>
                        <div
                            key={items._id}
                            className="card bg-white card-compact shadow-2xl p-2 rounded-none">
                            ...
                            <Link to={`/category/babyCare/${items._id}`}>
