...
const OrderConfirm = () => {
  ...
  const totalPrice = cart.reduce(
    (accumulator, currentValue) => currentValue.totalPrice + accumulator,
    0
  );
  ...
  return (
    <div className="mt-5 w-full">
      <h3 className="text-2xl font-semibold text-center text-indigo-500 py-3">
        Confirm your order
      </h3>
      <p className="text-center">
        To place your order, please give us some information!
      </p>
      <form onSubmit={handlePlaceOrder} className="">
          ...
          <div className="flex flex-col gap-3">
            <div className="form-control px-3">
              ...
              <input
                name="name"
                type="text"
                placeholder="Eg: Ismail Haniyeh"
                className="input input-bordered w-[90%] bg-gray-200"
                required
              />
            </div>
            <div className="form-control px-3">
              ...
              <input
                name="email"
                type="email"
                placeholder="Eg: ismailhaniyeh@gmail.com"
                className="input input-bordered w-[90%] bg-gray-200"
                required
              />
            </div>
          ...
          <div className="flex flex-col gap-3">
            <div className="form-control px-3">
              ...
              <input
                name="address"
                type="text"
                placeholder="Eg: house/road or vill, post code, p.s, district, division."
                className="input input-bordered w-[90%] bg-gray-200"
                required
              />
            </div>
        ...
        <div className="my-5 flex justify-center items-center gap-10">
          <h3 className="text-xl">
            Total selected item:{" "}
            <span className="2xl font-semibold text-indigo-500">
              {cart.length}
            </span>
          </h3>
          <h3 className="text-xl">
        ...
        <div className="form-control my-6">
          <button className="btn btn-warning w-1/4 ml-auto mr-auto">
            Confirm order
          </button>
        </div>
      </form>
