    ...
    return (
        <div className='p-5'>
            <div className='pt-2 pb-3'>
                <h3 className='text-xl font-semibold md:pl-2 pl-3 my-2 text-indigo-500'>Medical Devices</h3>
                <small className='md:pl-2 pl-3 text-gray-500'>{medicalDevices?.length} items found in Medical Devices</small>
            </div>
            <div className='grid lg:grid-cols-5 md:grid-cols-3 grid-cols-1 gap-5 justify-center md:my-10'>
                {
                    medicalDevices.map(items =>
                        <div
                            ...
                            <Link to={`/category/medicalDevices/${items._id}`}>
