...
const PersonalCareProductDetails = () => {
    const loadedPersonalCareProduct = useLoaderData();
    const { _id, img, title, quantity, price, details, brand } = loadedPersonalCareProduct;
...
export default PersonalCareProductDetails;