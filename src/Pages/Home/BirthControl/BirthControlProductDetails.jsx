...
const BirthControlProductDetails = () => {
    const loadedBirthControlProduct = useLoaderData();
    const { _id, img, title, quantity, price, details, brand } = loadedBirthControlProduct;
...
export default BirthControlProductDetails;