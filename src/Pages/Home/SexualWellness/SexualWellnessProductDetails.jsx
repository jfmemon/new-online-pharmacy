...
const SexualWellnessProductDetails = () => {
    const loadedSexualWellnessProduct = useLoaderData();
    const { _id, img, title, quantity, price, details, brand } = loadedSexualWellnessProduct;
...
export default SexualWellnessProductDetails;