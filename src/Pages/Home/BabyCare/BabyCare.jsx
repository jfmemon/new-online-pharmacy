...
const BabyCare = () => {
    ...
    return (
        <div className='md:mx-10 p-5 mb-10'>
            <div className='flex justify-center mt-10 mb-7'>
                <Link to="/category/babyCare">
                    <div className="divider md:w-[300px] w-60 mb-5 text-indigo-500 font-semibold hover:font-bold">Baby Care</div>
                </Link>
            </div>
            <Swiper
                slidesPerView={4}
            ...
            >
                {
                    babyCare.map(product => <SwiperSlide
                        key={product._id}
                    >
                        <div className="card bg-white h-96 card-compact drop-shadow-lg p-2 rounded-none">
                            ...
                            <Link to={`/category/babyCare/${product._id}`}>
