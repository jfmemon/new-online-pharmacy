...
const BabyCareProductDetails = () => {
    const loadedBabyCareProduct = useLoaderData();
    const { _id, img, title, quantity, price, details, brand } = loadedBabyCareProduct;
...
export default BabyCareProductDetails;