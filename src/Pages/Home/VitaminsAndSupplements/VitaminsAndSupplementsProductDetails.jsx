...
const VitaminsAndSupplementsProductDetails = () => {
    const loadedVitaminsAndSupplementsProduct = useLoaderData();
    const { _id, img, title, quantity, price, details, brand } = loadedVitaminsAndSupplementsProduct;
...
export default VitaminsAndSupplementsProductDetails;