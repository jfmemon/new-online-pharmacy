        ...
        <div className='md:mx-10 p-5'>
            <div className='flex justify-center mt-10 mb-7'>
                <Link to="/category/vitaminsAndSupplements">
                    <div className="divider md:w-[300px] w-60 mb-5 text-indigo-500 font-semibold hover:font-bold">Vitamins And Supplements</div>
                </Link>
            </div>
            <Swiper
                slidesPerView={4}
            ...
            >
                {
                    vitaminsAndSupplements.map(product => <SwiperSlide
                        key={product._id}
                    >
                        <div className="card card-compact bg-base-100 drop-shadow-lg p-2 rounded-none">
                            ...
                            <Link to={`/category/vitaminsAndSupplements/${product._id}`}>
