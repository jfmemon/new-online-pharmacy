        ...
        <div className='md:mx-10 p-5'>
            <div className='flex justify-center mt-10 mb-7'>
                <Link to="/category/medicalDevices">
                    <div className="divider md:w-[300px] w-60 mb-5 text-indigo-500 font-semibold hover:font-bold">Medical Devices</div>
                </Link>
            </div>
            <Swiper
                slidesPerView={4}
            ...
            >
                {
                    medicalDevices.map(product => <SwiperSlide
                        key={product._id}
                    >
                        <div className="card h-96 card-compact bg-white drop-shadow-lg p-2 rounded-none">
                            ...
                            <Link to={`/category/medicalDevices/${product._id}`}>
