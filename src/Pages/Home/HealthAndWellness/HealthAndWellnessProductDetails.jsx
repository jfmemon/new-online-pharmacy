...
const HealthAndWellnessProductDetails = () => {
    const loadedHealthAndWellnessProduct = useLoaderData();
    const { _id, img, title, quantity, price, details, brand } = loadedHealthAndWellnessProduct;
...
export default HealthAndWellnessProductDetails;