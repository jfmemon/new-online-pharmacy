            ...
            .then((data) => {
              if (data.insertedId) {
                Swal.fire({
                  ...
                  position: "top",
                  title:
                    "Your order has placed. We will contact with you soo. Thank you for ordering from us.",
                  showClass: {
    ...
    <div>
      <div className="w-full md:flex items-center justify-center p-5 gap-10">
        ...
        <form className="p-5 bg-slate-100" onSubmit={handleImageUpload}>
          <h2 className="text-2xl text-indigo-500 font-semibold text-center pb-5 pt-1 px-2">
            You can order by sending us your verified prescription!
          </h2>
